/*
clase “Familias.java” con los siguientes atributos:
• private int id;
 ...
 */
package extra.estancias.entidades;
...
public class Familias {
    ...
    public String toString() {
        return "Familia{" + "id=" + id + ", nombre=" + nombre + ", edad_minima=" + edad_minima + ", edad_maxima=" + edad_maxima + ", num_hijos=" + num_hijos + ", email=" + email + ", id_casa_familia=" + id_casa_familia + '}';
    }
